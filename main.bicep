...
param environmentType string = 'nonprod' // Keep as 'nonprod' for development or use a UAT-specific value if preferred.

@sys.description('The PostgreSQL Server name')
@minLength(3)
@maxLength(24)
param postgreSQLServerName string = 'ie-bank-db-server-dev' // Change this for UAT

@sys.description('The PostgreSQL Database name')
@minLength(3)
@maxLength(24)
param postgreSQLDatabaseName string = 'ie-bank-db' // Change this for UAT

@sys.description('The App Service Plan name')
@minLength(3)
@maxLength(24)
param appServicePlanName string = 'ie-bank-app-sp-dev' // Change this for UAT

@sys.description('The Web App name (frontend)')
@minLength(3)
@maxLength(24)
param appServiceAppName string = 'ie-bank-dev' // Change this for UAT

@sys.description('The API App name (backend)')
@minLength(3)
@maxLength(24)
param appServiceAPIAppName string = 'ie-bank-api-dev' // Change this for UAT
...
resource postgresSQLServer 'Microsoft.DBforPostgreSQL/flexibleServers@2022-12-01' = {
  ...
  properties: {
    ...
    administratorLoginPassword: 'IE.Bank.DB.Admin.Pa$$' // Consider parameterizing this for security
    createMode: 'Default'
    highAvailability: {
      mode: 'Disabled'
